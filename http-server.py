...
Thanks martijnvermaat - https://gist.github.com/martijnvermaat/4bec9bcc37d965e43879

Copy this file over into the build folder.
cd into build and run python http-server.py
"""
